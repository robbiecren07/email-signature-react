...
import EmptyTemplateTwo from './EmptyTemplateTwo'
                        ...
                        {imageURL.length !== 0 ? (
                          <>
                            <div style={{ width: '160px' }}>
                              <img src={imageURL} width="160" style={{ width: '160px', display: 'block', padding: '0', height: 'auto', border: '0px' }} alt="company logo" />
                            </div>
                          </>
                        ) : (
                          ''
